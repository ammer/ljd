...
def _read_counts_and_sizes(parser, prototype):
    ...
    if False:
        ...
        print("parser.complex_constants_count = " + str(parser.complex_constants_count))
        print("parser.numeric_constants_count = " + str(parser.numeric_constants_count))
        print("parser.instructions_count = " + str(parser.instructions_count))
        print("parser.debuginfo_size = " + str(parser.debuginfo_size))
        print("\n")
