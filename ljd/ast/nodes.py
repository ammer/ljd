...
class Identifier():
    ...
    def __str__(self):
        return "{ Identifier: {name: " + str(self.name) + ", type: " + ["T_SLOT", "T_LOCAL", "T_UPVALUE", "T_BUILTIN"][self.type] + \
               ", slot: " + str(self.slot) + "} }"
...
class UnconditionalWarp():
    ...
    def __str__(self):
        return "{UnconditionlWarp: {type: " + ["T_JUMP", "T_FLOW"][self.type] + ", target: " + str(self.target) + ", is_uclo: " + \
               str(self.is_uclo) + " }}"
